...
аккуратный dev-bypass для localhost (без костылей)

Сегодня ты сделал главное — система в зелёной зоне.
Лучше на этом и остановиться, чем лезть дальше уставшим.

Завтра просто скажи:
«Продолжаем с auth» — и поехали.
